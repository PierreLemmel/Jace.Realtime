...
namespace Jace.RealTime.Tests
{
    ...
    public class TokenReaderTests
    {
        ...
        public void TestTokenReader1()
        {
            ...
            Assert.AreEqual(42.0f, tokens[0].Value);
            ...
            Assert.AreEqual(31.0f, tokens[2].Value);
        ...
        public void TestTokenReader2()
        {
            ...
            Assert.AreEqual(42.0f, tokens[1].Value);
            ...
            Assert.AreEqual(31.0f, tokens[3].Value);
        ...
        public void TestTokenReader4()
        {
            ...
            Assert.AreEqual(8.0f, tokens[3].Value);
            ...
            Assert.AreEqual(2.0f, tokens[6].Value);
        ...
        public void TestTokenReader5()
        {
            ...
            Assert.AreEqual(42.87f, tokens[1].Value);
            Assert.AreEqual(1, tokens[1].StartPosition);
        ...
        public void TestTokenReader10()
        {
            ...
            Assert.AreEqual(2.0f, tokens[2].Value);
            Assert.AreEqual(5, tokens[2].StartPosition);
            Assert.AreEqual(1, tokens[2].Length);
        }
        ...
        public void TestTokenReader11()
        {
            ...
            Assert.AreEqual(5.1f, tokens[0].Value);
            Assert.AreEqual(0, tokens[0].StartPosition);
        ...
        public void TestTokenReader12()
        {
            ...
            Assert.AreEqual(-2.1f, tokens[0].Value);
            Assert.AreEqual(0, tokens[0].StartPosition);
            Assert.AreEqual(4, tokens[0].Length);
        }
        ...
        public void TestTokenReader13()
        {
            ...
            Assert.AreEqual(5.0f, tokens[0].Value);
            Assert.AreEqual(0, tokens[0].StartPosition);
            Assert.AreEqual(1, tokens[0].Length);
        ...
        public void TestTokenReader15()
        {
            ...
            Assert.AreEqual(-2.0f, tokens[3].Value);
        ...
        public void TestTokenReader16()
        {
            ...
            Assert.AreEqual(2.0f, tokens[4].Value);
            ...
            Assert.AreEqual(43.0f, tokens[6].Value);
        ...
        public void TestTokenReader17()
        {
            ...
            Assert.AreEqual(5.0f, tokens[4].Value);
        ...
        public void TestTokenReader20()
        {
            ...
            Assert.AreEqual(2.11E-3f, tokens[0].Value);
            Assert.AreEqual(0, tokens[0].StartPosition);
        ...
        public void TestTokenReader21()
        {
            ...
            Assert.AreEqual(2.11E-3f, tokens[2].Value);
            Assert.AreEqual(6, tokens[2].StartPosition);
        ...
        public void TestTokenReader23()
        {
            ...
            Assert.AreEqual(2.11E3f, tokens[0].Value);
            Assert.AreEqual(0, tokens[0].StartPosition);
        ...
        public void TestTokenReader24()
        {
            ...
            Assert.AreEqual(1.0f, tokens[0].Value);
            Assert.AreEqual(0, tokens[0].StartPosition);
            Assert.AreEqual(1, tokens[0].Length);
